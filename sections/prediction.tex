...
- Wir haben ja bereits festgestellt, dass viele Ampeln, wenn sie Daten schicken, nach der Qualitätsmetrik des Algorithmus relativ akkurat prognostiziert werden können
- Der gewählte Algorithmus scheint also nicht nur gut zu skalieren, sondern auch bisher überraschend gut selbst mit den vielen verkehrsabhängigen Ampelschaltungen in Hamburg zu funktionieren. 
- Diese Beobachtung steht im Kontrast mit den bisherigen Arbeiten, die eher das Gegenteil haben vermuten lassen
- Natürlich haben wir bisher nur Fahrradampeln betrachtet, die nur einen Teil des Bildes zeichnen. Daher schauen wir uns als nächstes nochmal die Verkehrsabhängigkeit für alle Ampeln in Hamburg an. Hiermit wollen wir nicht nur tiefergehende Einblicke in die Ampelschaltungen erhalten, sondern auch abschließend klären, an welchen Stellen wir das laufende Prognosesystem noch weiter optimieren können

% Paper: Out of the six weeks, we apply our method to four weeks starting on 2023-09-23, 0 am and ending on 2023-10-20, 12 pm. During this period, there are $\approx1,2$ billion signal state data points and $\approx1$ billion cycle data points. The remainder of the data points either lie outside of this period or come from other data sources, such as car/bus detectors.
...
- Immer rote Ampeln näher betrachten
