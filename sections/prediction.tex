...
- Bisherige Arbeiten haben sich nur eingeschränkt damit beschäftigt, was Prognostizierbarkeit eigentlich genau bedeutet.
- Wie prognostizierbar eine Ampel ist, hängt nicht nur von ihrer Verkehrsadaptivität, sondern auch vom Verfahren ab, mit dem die Prognose durchgeführt wird.
- Das auch in dieser Arbeit genutzte probabilistische Verfahren kann gut mit Schwankungen in Grünphasen umgehen, solange diese zwischen den Zyklen ungefähr übereinander liegen, also zu einer ähnlichen Zeit beginnen. Wenn dies gegeben ist, ist das probabilistische Verfahren sehr attraktiv aufgrund seiner niedrige
- Was nicht gut prognostiziert werden kann sind Muster, die sich nicht im Einklang mit den Zyklen wiederholen. 
