...
- Mit den zur Verfügung stehenden Echtzeitdaten der Ampeln in Hamburg können wir unser Vorgehensmodell anschließend umsetzen und Erkenntnisse über die tatsächliche Prognostizierbarkeit von Ampeln ableiten. Direkte Messungen der Prognostizierbarkeit gab es in dieser Form auch bisher noch nicht.

- Wie gut prognostizierbar eine Ampel ist, hängt davon ab, wie gut sich Muster in der Schalthistorie erkennen lassen. 
- Der einfachste Fall ist, wenn jeder sich wiederholende Zyklus der Ampel gleich schaltet. Alternativ kann es auch sein, dass die Grünphase nicht mit dem Zyklus synchronisiert ist, aber in gleichen zeitlichen Abständen schaltet. Auch dieser Fall entspricht grundsätzlich einem sehr leicht zu erkennenden Muster.
...
\hline
\rotatebox{90}{\footnotesize{\textbf{High cycle-independent instability}}} & \includegraphics[width=0.42\linewidth]{images/predictability-cycles-1.pdf} & \includegraphics[width=0.42\linewidth]{images/predictability-cycles-2.pdf} \\
\hline
\rotatebox{90}{\footnotesize{\textbf{Low cycle-independent instability}}} & \includegraphics[width=0.42\linewidth]{images/predictability-cycles-3.pdf} & \includegraphics[width=0.42\linewidth]{images/predictability-cycles-4.pdf} \\
\hline
\end{tabular}
\caption{.}
...
- Zwei Arten von Instabilitäten sind besonders relevant für Prognoseverfahren: cycle-dependent instability und cycle-independent instability. 
- Wie in  \Cref{fig:types-of-instability} gezeigt kann man sich vier verschiedene Fälle vorstellen:
- Links unten ist ein Ampelschaltprogramm, das jeden Zyklus gleich schaltet, mit zwischenzeitlich eventuell auftretendem Programmwechsel. Solche Programme sind am stabilsten und daher auch am besten prognostizierbar.
- Links oben wird die Grünphase nur gelegentlich freigeschaltet, aber dann zu einem festen Zeitpunkt im Zyklus. Schwerer zu prognostizieren ist der Zeitpunkt der Freischaltung, während das auftretende Muster im Zyklus sehr gleichmäßig ist. Die zyklusunabhängige Instabilität ist groß, während die zyklusabhängige Instabilität gering ist.
- Rechts unten wird die Grünphase sehr regelmäßig freigeschaltet, aber verschiebt sich mit jeder Freischaltung im Zyklus. Die zyklusabhängige Instabilität ist groß, während die zyklusunabhängige Instabilität gering ist.
- Rechts oben sind beide Arten von Instabilität sehr hoch. Die Prognostizierbarkeit ist somit stark eingeschränkt.
