...
- A: Links unten ist ein Ampelschaltprogramm, das jeden Zyklus gleich schaltet, mit zwischenzeitlich eventuell auftretendem Programmwechsel. Solche Programme sind am stabilsten und daher auch am besten prognostizierbar. Ein probabilistisches Verfahren ist derzeit die skalierbarste und robusteste Wahl. Graphbasierte oder ML-basierte Modelle lohnen sich hier eher nicht im Tradeoff.
- B: Links oben wird die Grünphase nur gelegentlich freigeschaltet, aber dann zu einem festen Zeitpunkt im Zyklus. Schwerer zu prognostizieren ist der Zeitpunkt der Freischaltung, während das auftretende Muster im Zyklus sehr gleichmäßig ist. Die zyklusunabhängige Instabilität ist groß, während die zyklusabhängige Instabilität gering ist. Auch hier ist ein probabilistisches Verfahren eine gute Wahl, da es die Chance in manchen Fällen eine Freigabe zu erhalten trotzdem reflektiert und somit die Möglichkeit bietet, sich an den Bereich, in dem eine Grünphase geschaltet werden könnte, zu adaptieren. 
- C: Rechts unten wird die Grünphase sehr regelmäßig freigeschaltet, aber verschiebt sich mit jeder Freischaltung im Zyklus. Die zyklusabhängige Instabilität ist groß, während die zyklusunabhängige Instabilität gering ist. Diese Art von Ampeln kann nur schwer von probabilistischen Modellen prognostiziert werden. Eine gute Alternative für diese Art von Ampeln sind graphbasierte Methoden, da diese die Phasenlänge statt der Lokalität im Zyklusvektor zur Prognose nutzen.
- D: Rechts oben sind beide Arten von Instabilität sehr hoch. Die Prognostizierbarkeit ist somit stark eingeschränkt, für alle Arten von Modellen. Eine gute Alternative wären jedoch in diesem Fall Machine-Learning-basierte Modelle, da diese die höchste Chance haben, komplexere Muster zu erkennen
- 

- Konsequenzen für Prognosealgorithmen?
