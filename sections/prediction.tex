...
- Orientieren sich die Muster an der Zykluslänge der Ampel, so ist eine Prognose über das probabilistische Verfahren möglich. Wiederholen sich Abstände zwischen Grünphasen, aber finden die Grünphasen nicht immer um den gleichen Zeitpunkt im Zyklus statt, so ist eine Prognose über das probabilistische Verfahren stark eingeschränkt. In diesem Fall müsste zu alternativen Methoden wie graphbasierten oder machine-learning-methoden gegriffen werden. Im Wesentlichen 
