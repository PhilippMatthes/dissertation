...
\caption{Decision boundaries of the ML model's Yeo-Johnson-transformed non-categorical features. To create this plot, the ML model was executed multiple times on random routes, logging which constellations were marked as a match (green) or no match r)}
