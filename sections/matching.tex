...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{images/sg-selection-unconnected-intersections.png}
\caption{Integration of unconnected intersections through the Lichtsignalanlagen Hamburg dataset.}
\label{fig:sg-selection-unconnected-intersections}
\end{figure}
