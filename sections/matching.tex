...
\centering 
\begin{tabular}{cc}
\includegraphics[width=0.45\linewidth]{images/matching-model-loss-curve-ml-osm.pdf} & \includegraphics[width=0.45\linewidth]{images/matching-model-ml-osm.pdf} \\
\end{tabular}
\caption{.}
\label{fig:}
\end{figure}
