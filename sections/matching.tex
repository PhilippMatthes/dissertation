...
- Die Evaluation des traffic light matching ist in drei Teile geteilt.
- Zunächst schauen wir uns die Charakteristika der Ampelgeometrien in Hamburg an. Ein besonderer Fokus liegt hierbei auf der Länge der Ingress Lanes, um nochmal genauer zu untersuchen, wie kurz Einfahrtsspuren für Radfahrer tatsächlich sind. Dies entscheidet darüber, ob ein Location-based approach überhaupt für Radfahrer umsetzbar ist, da dieser eine möglichst lange Einfahrtsspur für das Snapping zur Spur erfordert
- Anschließend betrachten wir die Ground Truth und ob diese repräsentativ genug ist, um qualifizierte Aussagen über die Genauigkeit der entwickelten Verfahren zu machen
