...
The Tree-Structured Parzen Estimator hyperparameter tuning algorithm \cite{ozaki_multiobjective_2020} is utilized to find a good configuration on the ground truth benchmark. The objective function given to the tuner algorithm is the F1 score. The final model configuration for OpenStreetMap is highlighted in \Cref{tab:hyperparameter-tuning-results}.
