...
Through measurement, it could be confirmed that the ingress geometries of bike traffic lights are much shorter than those for buses and cars. Together with multiple ambiguous turning directions and various choices for bike traffic lights at each intersection 
\end{Summary}
