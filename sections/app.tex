...
The relation between a user interface and reaction to the speed advisory has not always been tested in correspondence, meaning that many studies have been conducted without a human in the loop. Often, a driver model is utilized to simulate the reaction to the speed advisory \cite{hu_lane-level_2023}, incorporating a model of the vehicle's acceleration and deceleration behavior and, sometimes, human interaction delay \cite{schlamp_2023_glosa}. Typically assuming constant obedience to the speed advisory, these studies fall short of depicting the reaction to the speed advisory realistically. 

However, in such studies, it is typically assumed that the human constantly follows the speed advisory, 

In some other notable studies by Preuk et al. (2016 -- 2018) \cite{preuk_does_2016, preuk_should_2018} 
