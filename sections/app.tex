...
Our survey will later show us that some users seem to have been dissatisfied with the app, not attempting to reuse it. One of the main reasons is the sometimes decreased prediction availability, as seen in \Cref{fig:app-usage-over-time}, especially on July 11, 2023. 
...
All respondents of the survey considered themselves to be experienced cyclists -- none selected the option "inexperienced." When asked which type of activity users would prefer a car over a bike, 12 respondents reported using a car for shopping activities. Also, 12 responses were related to free time activities or vacations, while 8 answers considered daily work commutes as a reason to prefer a car. Transporting larger goods such as furniture or general errands (6) or longer distances (4) play a role in the decision as well. However, in general, a noticeable part of respondents seemed to make clear they already prefer the bike in most ways. Notably, 3 subjects responded they avoid a car in any situation. We generally observe that many users who responded to our survey are already highly engaged in bike riding: 26 users use their bike on a daily basis, 12 users occasionally during the week, and 2 users sometimes on a monthly basis. This kind of bias will be considered in the detailed user opinion analysis.
