...
The proposed concept addresses these research gaps as follows. All three identified visualization methods for the speed advisory are tested preliminarily to derive a thorough understanding of their individual drawbacks and advantages within a real-world cycling context. One method, the speedometer visualization, is selected as the final choice. Similar to previous works, we develop a hybrid approach showing both a speed advisory and a traffic light countdown. This approach allows us to enhance both cycling situations: standing at a red light and adjusting one's speed driving towards it.
...
The presented final application is intended as a companion for day-to-day bike rides. Secondly, it is also a cornerstone that brings all developed components from previous chapters together: traffic light prediction, traffic light matching, and accurate bike routing.
...
\subsection{Speedometer Projection with Countdown}
