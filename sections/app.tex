...
Im Unterschied zu bisherigen fahrradbezogenen Studien wird die Studie in dieser Arbeit nicht in einer kontrollierten experimentellen Umgebung durchgeführt. Stattdessen können sich Hamburger frei für den Test registrieren, sich anschließend die App herunterladen, und komplett selbstständig und nach den eigenen Bedürfnissen verwenden. Dazu gehört auch, dass die Nutzer eine freie Route durch Hamburg wählen können, entlang derer viele verschiedene angebundene, nicht angebundene, gut oder schlecht prognostizierbare Ampeln liegen können. Die Studie wird für einen Zeitraum von einem Jahr durchgeführt, während sich die App im Beta-Stadium befand.

Auf diese Weise erreichen wir ein möglichst realistisches Bild der Auswirkungen von einer Geschwindigkeitsempfehlung auf Radfahrende. Natürlich bringt dies viele weitere Schwierigkeiten mit sich, besonders bei der Analyse der Daten, da viele zuvor nicht berücksichtigte Situationen auftreten können und auch ganz unterschiedliche Gerätetypen verwendet werden. Diese Schwierigkeiten bei der Auswertung zu überwinden und trotzdem zu reliablen Schlussfolgerungen zu kommen ist einer der Kernaspekte in dieser abschließenden Evaluation.

Die den Test begleitende Evaluation wird in zwei Arten durchgeführt. Zunächst wird eine Nutzerbefragung über unsere App durchgeführt, an denen sich unsere Testnutzer frei beteiligen können. Hieraus gewinnen wir demografische Statistiken unserer Nutzerbasis, die standardisierte SUS zur Usability-Bewertung unserer App, aber auch detaillierteres Individualfeedback zu positiven aber auch verbesserungswürdigen Aspekten. 

Anschließend gehen wir zu einer quantitativen Analyse über. Durch eine Studie der aufgezeichneten Interaktionen mit dem User Interface testen wir, wie häufig Nutzer physisch mit dem Smartphone interagieren, und wie sich potenziell gefahrenbringende Interaktionen während der Fahrt noch weiter reduzieren ließen.

Zum Schluss folgt der Kern unserer quantitativen Evaluation. Wir betrachten die Auswirkung der Geschwindigkeitsempfehlung auf die Kreuzungszufahrt, und errechnen mehrere Impact-Metriken. Um zwischen gut nutzbaren und schlecht nutzbaren Geschwindigkeitsempfehlungen zu trennen, messen wir zunächst die Adhärenz des Nutzers an die empfohlene(n) Grünphase(n). Hiermit können wir drei Fälle betrachten: Kreuzungszufahrten ohne Geschwindigkeitsempfehlung, Kreuzungszufahrten mit Geschwindigkeitsempfehlung an die sich gehalten wurde, und Kreuzungszufahrten bei denen die Geschwindigkeitsempfehlung aus verschiedenen Gründen nicht genutzt wurde. Mit dieser Trennung und den aufgezeichneten Tracks errechnen wir: den Einfluss auf die Kreuzungszufahrtsgeschwindigkeit, den daraus folgenden Mehr/Wenigeraufwand an Energie, sowie die Anzahl von Stops und die Haltezeit.

Nach einer Kreuzvalidierung der ermittelten Ergebnisse erlauben uns die erhobenen quantitativen und qualitativen Daten ein Gesamtfazit zu ziehen, und die Wirkung unseres Systems zu bestimmen.
...
- Time of recording: March 2023 - December 2023
- Number of users: 126 distinct user ids generated
- Number of tracks: 1,330
- Relation to prediction availability, bulks of riding (explanation)
- A few highly engaged users: \#305ee0 (201), \#3494b0 (150), \#ff00f0 (91), \#0a9580 (59), remaining 122 users $\leq$ 50 tracks
- 35 users with only 1 uploaded track
- Median \# tracks per user: 3.5 (IQR: 8.75)

- Number of survey respondents: 279 started survey, 40 filled out all questions
- General demographics of the user basis
- Median Age: 37 (IQR: 22.5), min: 18, max: 65 
- Male: 34, Female: 5, Diverse: 1
- Occupations: 30 employed, 9 other occupations (3 student, 2 self-employed, 1 apprentice, 3 other such as pensioner)
