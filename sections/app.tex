...
\begin{figure}[t]
\caption{T.}\label{fig:}
\includegraphics[width=\linewidth]{images/app-usability-questions-route-planning-personalization.pdf}
\end{figure}

\begin{figure}[t]
\caption{T.}\label{fig:}
\includegraphics[width=\linewidth]{images/app-usability-questions-general-routing-personalization.pdf}
\end{figure}

\begin{figure}[t]
\caption{T.}\label{fig:}
\includegraphics[width=\linewidth]{images/app-usability-questions-general-route-planning.pdf}
\end{figure}

\begin{figure}[t]
\caption{T.}\label{fig:}
\includegraphics[width=\linewidth]{images/app-usability-questions-general-routing-accuracy.pdf}
\end{figure}

\begin{figure}[t]
\caption{T.}\label{fig:}
\includegraphics[width=\linewidth]{images/app-usability-questions-route-planning-with-glosa.pdf}
\end{figure}
