...
- State of the art modell für Radfahrer?
- Aktivierungsdistanz
- Transmissionsrate der Prognosenachrichten
- Penetration rate des Systems: Xu et al. (2015) \cite{xu_bb_2015}: "To avoid the interference of other vehicles, the field tests were conducted in late night, which means that the algorithm was applied in free-flow conditions"
