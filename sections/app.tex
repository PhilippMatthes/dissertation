...
\begin{figure}[t]
\caption{.}\label{fig:}
\includegraphics[width=0.5\linewidth]{images/app-demographics-municipalities.pdf}
\end{figure}
...
- SUS Score
% Number of scores: 33
% Mean: 73.03030303030303
% Median: 72.5
% Std: 13.410160888657815
% Min: 42.5
% Max: 95.0
...
\subsection{User Interface Interaction During Ride}
...
\subsection{Collected Trajectories}
...
- Nr of trajectories, how many users, ...
- Source-drain matrix
