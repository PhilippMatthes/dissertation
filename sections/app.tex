...
- Es gibt unterschiedliche Ansätze, die Geschwindigkeitsempfehlung in Gesamtsystemen zu integrieren.
- In den Arbeiten von Zweck et al. (2013) \cite{zweck_traffic_2013} und auch später von Stahlmann et al. (2018) \cite{stahlmann_exploring_2018} am System von Audi steht das Gesamtsystem Fahrzeug im Fokus. Die Geschwindigkeitsempfehlung wird mit anderen Komponenten des Infotainments verknüpft, und erhält wichtige Zusatzinformationen wie den Zustand des Blinkers vom 
- In einer aktuellen Arbeit von Ding et al. (2023) \cite{ding_speedadv_2023} findet die Darstellung als Zusatzelement in einer Navigationsapp platz, indem ein kleiner Kreis mit der Zielgeschwindigkeit dargestellt wird

Ding et al. (2023) \cite{ding_speedadv_2023}
- User Reviews on Traffic Pilot --> Fehlendes Routing etc.
