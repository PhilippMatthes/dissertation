...
Diverse solutions have been recently developed to make cycling smarter and decrease discomfort. One solution explored is warning cyclists of acute dangers along their pathway using crowdsourced data\footnote{Project Rad im Fokus: \url{https://www.synchrone-mobilitaet.de/de/projekte/rad-im-fokus.html}}. Collecting cycling data, especially GNSS trajectories, is a promising solution to locate 

Cooperative cycling and allowing cyclists to form platoons have also been recently explored as a solution to bring cyclists together, focusing on the community aspect of cycling \cite{cespedes_group_2019, meng_connected_2022}.

Given a more individualized perspective, stopping at traffic lights is considered a key discomfort factor for cyclists \cite{otto_framework_2023}. 

- SiBike (now YuBike) app: Ampeln mit App grün schalten https://www.de.digital/DIGITAL/Redaktion/DE/Smart-City-Navigator/Projekte/sibike-app.html
- Static info boards vs. mobile apps, LED lines, ... \cite{de_angelis_green_2019} "Based on our findings, we argue that the numeric-based countdown represents the most promising option for future adaptive green wave implementations."
- Projekt Leezenflow (Countdown timer at traffic lights) in Münster \cite{brand_riding_2024}: 6.6\% stop reduction at 1 traffic light - How can we improve this? -> mobile app, large scale
