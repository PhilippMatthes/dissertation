...
- Male: , Female: , Diverse: 
- Occupations: 30 employed (76.92\%), 9 other occupations (3 student, 2 self-employed, 1 apprentice, 3 other such as pensioner)

- Favorite bike navigation app: 17 Komoot (43.59\%), 13 Google Maps (33.33\%), 9 Other including bike citizens (2) and PrioBike (2)
- Preferred bike type: 19x City bike (31.67\%), 10 x Trekking bike (16.67\%), 6x MTB (10\%), 5x Racing bike (8.33\%), 4x cargo bike (6.67\%), 1 other: "commuter"
- Also 12x e-bike (20\%), 6 offroad and 6 onroad capable
