...
Based on the different speeds during the approach, we can calculate the energy expenditure during and after the traffic light approach. The simplified model by Tal et al. (2016) \cite{tal_vehicular-communications-based_2016} based on parameters from Muetze et al. (2007) \cite{muetze_electric_2007} is not adopted here since it does not incorporate the acceleration force. Instead, we utilize the model proposed by Dabiri et al. (2020) \cite{dabiri_optimized_2020} with an air density of 1.247 kg/m$^3$, a frontal area of 0.616 m$^2$, a rolling resistance of 0.008, and drag coefficient of 1.2. We also use the same combined bike and cyclist mass of 95 kg together with a rotational wheel mass of 0.95 kg for acceleration force calculation. Like Dabiri et al. (2020) \cite{dabiri_optimized_2020}, we assume a wind speed of 0 km/h as we have no meaningful way of measuring this value. One simplification is that we assume a slope grade of 0\%, as Hamburg can be considered generally flat in most areas. The intention is to avoid errors from the GNSS's height measurement or the route's height profile that transcend into the energy determination.

Based on this cyclist model, for the described region of 150m before to 50m after the traffic light, we calculate an average energy of 22.75 kJ traveled without GLOSA. With GLOSA, the energy expenditure is reduced by 2.99\% to 22.07 kJ. However, there are again two separate effects: In cases with >50\% adherence to the speed advisory, the energy expenditure increases by 6.51\% to 24.23 kJ, mainly due to the higher maintained speed that increases air and rolling resistance. However, in cases where users adhered less than 50\% to the speed advisory, the energy expenditure decreases by 9.32\% 

- Resulting energy savings
- Average kJ with GLOSA: 22.07
- Average kJ with GLOSA and adherence > 50\%: 24.23 
- Average kJ with GLOSA and adherence < 50\%: 20.63 
- Average kJ without GLOSA: 22.75
