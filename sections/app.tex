...
- CO2-Emission wird manchmal abgebildet auf die Fuel Consumption: Seredynski et al. (2013) \cite{seredynski_comparison_2013, seredynski_multi-segment_2013}: "In general, emissions of CO2 are linearly related to fuel consumption [11, 12]"
- Werte reihen sich in einer sehr diversen Spanne ein: 0.5\% \cite{stevanovic_green_2013, stevanovic_comparative_2014}, 1.3\% - 4\% \cite{xia_indirect_2011}, 3\% \cite{olaverri-monreal_implementation_2018}, 3\% - 15\% \cite{bhattacharyya_assessing_2022}, 4.5\% \cite{pariota_green_2019}, 5\% \cite{khan_eco-drive_2021}, 6\% \cite{hao_eco-approach_2019}, 4.9\% (rw) -- 11.8\% \cite{zhang_green_2020}, 9,27\% \cite{lu_green_2020}, 10\% \cite{suzuki_new_2018, suzuki_safety_2020},  10.1\% \cite{plianos_predictive_2018}, 11.5\% \cite{eckhoff_potentials_2013}, 13.59\% \cite{xia_field_2012}, 38.1\% \cite{simchon_real-time_2020}
- Sehr diverse ergebnisse
