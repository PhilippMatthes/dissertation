...
Based on the model, cycling without GLOSA toward traffic lights (150m before to 50m after) results in a median spending of 42.07 kJ (IQR: 25.38 kJ). Compared to this baseline, cycling with GLOSA results in a 1.4\% increase in energy expenditure at 41.47 kJ (IQR: 29.62 kJ). Split into the two classes, the difference becomes more clear. Without adherence to the speed advisory, users save 

- Resulting energy savings
Average kJ with GLOSA: 31.86 
Average kJ with GLOSA and adherence > 50\%: 33.15 
Average kJ with GLOSA and adherence < 50\%: 30.96 
Average kJ without GLOSA: 31.54
...
- Shift between adherence cases with better prediction reliability?
\end{Summary}
