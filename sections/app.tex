...
- Werte reihen sich in einer sehr diversen Spanne ein: 0.5\% \cite{stevanovic_green_2013, stevanovic_comparative_2014}, 1.3\% - 4\% \cite{xia_indirect_2011}, 3\% \cite{olaverri-monreal_implementation_2018}, 4.5\% \cite{pariota_green_2019}, 5\% \cite{khan_eco-drive_2021}, 6\% \cite{hao_eco-approach_2019}, 4.9\% (rw) -- 11.8\% \cite{zhang_green_2020}, 9,27\% \cite{lu_green_2020}, 11.5\% \cite{eckhoff_potentials_2013}, 13.59\% \cite{xia_field_2012}, 
