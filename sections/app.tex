...
Diverse user interfaces have been proposed over time to present a traffic light speed advisory, as highlighted in \Cref{fig:related-work-hmi-piechart}. The most prevalent type of visualization is displaying a target speed that should be followed to pass the traffic light on green. This approach was envisioned first by Otto et al. (2010) \cite{otto_operating_2010}, among other types of visualizations. After being adopted by Koukoumidis et al. (2011) \cite{koukoumidis_signalguru_2011, koukoumidis_leveraging_2012} for the "SignalGuru" mobile application, 
