...
\begin{figure}[t]
\caption{T.}\label{fig:}
\includegraphics[width=\linewidth]{images/example-trajectory.png}
\end{figure}


\begin{figure}[t]
\caption{T.}\label{fig:}
\includegraphics[width=\linewidth]{images/example-trajectory-2.png} 
\\
\includegraphics[width=\linewidth]{images/example-trajectory-3.png}
\end{figure}
