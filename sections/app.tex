...
- Eine leichte Abwandlung zeigen Marias Parella et al. (2019) \cite{marias_parella_design_2019}. Hier wird kein Text dargestellt, sondern die Zielgeschwindigkeit im Tacho markiert. Xu et al. (2015) \cite{xu_bb_2015} zeigen wie eine hybride Anwendung des Zielgeschwindigkeitsansatzes durch Zuhilfenahme auditiver Prompts umgesetzt werden kann. Die Signal2X App von Yunex \cite{yunex_traffic_v2x-kommunikation_2023} geht noch einen Schritt weiter und zeigt für mehrere parallele Ampeln eine Zielgeschwindigkeit an. In einer aktuellen Arbeit von Ding et al. (2023) \cite{ding_speedadv_2023} findet die Darstellung als Zusatzelement in einer Navigationsapp platz, indem ein kleiner Kreis mit der Zielgeschwindigkeit dargestellt wird
