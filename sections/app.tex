...
- Studien zu Impacts können in zwei Aspekte aufgeteilt werden: Quantitative Messungen der Energieersparnis und Haltereduktion an Kreuzungen, und die Auswirkungen auf das subjektive Empfinden
...
- Zweiter untersuchter Impact: Reduktion der Stop time bzw. stop rate. 
...
- Bisher gibt es dafür aber nur einen Datenpunkt von Suramardhana et al. (2014) \cite{suramardhana_driver-centric_2014}. Hier wurde bei der Zufahrt auf eine Teststrecken-Kreuzung in Korea eine Haltezeitreduktion von 23.9\% gemessen. Zur genauen Messung, auch bzgl. GNSS-Genauigkeit des Smartphones, ist jedoch nicht viel bekannt.
