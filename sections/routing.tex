...
\caption{An overview of the DRN dataset and its bike path types, as of December 23, 2023.}
\label{fig:drn-map}
\end{figure}
...
\caption{Duplicated nodes (left) are merged (right) to avoid detours. Source: \cite{lorenz_2022}}
...
\caption{Detour (left) that can be fixed by enabling opposite-direction one-way travel on foot (right), compared to OpenStreetMap route (blue). Source: \cite{lorenz_2022}}
