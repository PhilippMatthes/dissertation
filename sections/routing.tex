...
Storyline
- 1. Wir berechnen Routen mit DRN und wählen händisch dazu die passenden Ampelgeometrien aus -> Ground truth. Außerdem markieren wir uns die Typen von Konstellationen und Routing-Fehlern an den Kreuzungen
...
\centering 
\begin{tabular}{cc}
\includegraphics[width=0.45\linewidth]{images/matching-ground-truth-progression-drn.pdf} & \includegraphics[width=0.45\linewidth]{images/matching-ground-truth-lsas-per-route-drn.pdf} \\
\end{tabular}
\caption{.}
\label{fig:}
\end{figure}
