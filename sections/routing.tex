...
\begin{table}[htbp]
    \centering
    \caption{Mapping of GraphHopper routing profiles for route personalization.}
    \begin{tabular}{lll}
        \hline
        \textbf{Selected Bike Type}& \textbf{Selected Preference Type}& \textbf{Selected Routing Profile}\\
        \hline
        \multirow{2}{*}{Mountain Bike} & Fast & mtbFastest \\
        & Default & mtbDefault \\
        \hline
        \multirow{2}{*}{Racing Bike / Cargo Bike} & Fast & racingbikeFastest \\
        & Default & racingbikeDefault \\
        \hline
        \multirow{2}{*}{N/A (Assuming Sport)} & Fast & bikeFastest \\
        & Default & bikeDefault \\
        \hline
        \multirow{2}{*}{N/A} & Fast & bike2Fastest \\
        & Default & bike2Default \\
        \hline
    \end{tabular}
