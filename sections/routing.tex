...
- In jedem Fall gibt es fast doppelt so viele Beispiele, bei denen die Routengeometrie fast identisch mit der traffic light geometry verläuft.
...
- Weniger substanzielle Unterschiede ergeben sich bei Konstellationen, in denen die Route divergent oder konvergent zur Spurgeometrie verläuft -- auch dies kommt in DRN seltener vor. 
