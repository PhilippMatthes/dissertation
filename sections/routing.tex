...
\begin{figure}[htbp]
\centering 
\includegraphics[width=\linewidth]{images/routing-distance-traveled-on-off-route.pdf}
\caption{.}
\label{fig:}
\end{figure}
