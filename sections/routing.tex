...
As Huber et al. (2021) \cite{huber_modelling_2021} have demonstrated, achieving a high level of accuracy in route choice prediction is strongly tied to having highly consistent meta-information about bike path type, surface quality, and also speed limits of surrounding motorized traffic. Thus, route choice models are naturally limited to the consistency of such meta-information within the utilized map material. In consequence, the consistency of meta-infor
