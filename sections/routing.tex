...
- Die Anzahl der Situationen ohne Routing fehler wurde fast verdreifacht, von 23\% in OpenStreetMap auf 64\% aller Samples in DRN. Der Hauptgrund für die Verbesserung ist, dass nun die Fahrradfurten und Fahrradwege viel häufiger korrekt genutzt werden, anstelle in der Mitte der Straße zu routen. Vollständig eliminiert werden konnte dieser Fall jedoch nicht. Außerdem wird deutlich seltener auf der falschen Straßenseite geroutet.

\begin{table}[htbp]
\centering
\begin{tabular}{@{}lrr@{}}
\hline
\textbf{Observed Error Cases} & DRN & OSM \\ \hline
...
- Eine detailliertere Case Study, in der Max Lorenz 72 zufällige Routen untersucht hat, kommt zu ähnlichen Ergebnissen. Diese sind in \Cref{tab:accuracy-comparison} gezeigt.
- 
