...
The concept aims to address the described research gaps in two ways. First, we develop a concept for substituting regions in OpenStreetMap with a patch obtained from our authoritative dataset, DRN. Focusing on the reusabilitThis substitution could then be repeated for other regions.

We focus on the reusability of our methods, providing an entirely automatable approach without the necessity of human intervention. 
