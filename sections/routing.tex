...
\toprule
\textbf{Reference}& \multicolumn{3}{c}{\textbf{DRN}}&\multicolumn{3}{c}{\textbf{OpenStreetMap}}&\multicolumn{3}{c}{\textbf{Bing Maps (Driving)}}&\multicolumn{3}{c}{\textbf{Bing Maps (Walking)}}&\multicolumn{3}{c}{\textbf{Google Maps}}\\
\textbf{Track}& \textbf{HD} & \textbf{Mean} & \textbf{W} & \textbf{HD} & \textbf{Mean} & \textbf{W} & \textbf{HD} & \textbf{Mean} & \textbf{W} & \textbf{HD} & \textbf{Mean} & \textbf{W} & \textbf{HD} & \textbf{Mean} & \textbf{W} \\
\midrule
