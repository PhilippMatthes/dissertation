...
\begin{tabular}{|p{8.5cm}p{3cm}p{3cm}p{3cm}p{6cm}|}
    ...
    \hline
    Aufgeweiteter Radaufstellstreifen & \texttt{\textcolor{ciblue}{tertiary}} & -- & -- & -- \\
    Busfahrstreifen mit Radverkehr & \texttt{\textcolor{ciblue}{service}} & \texttt{\textcolor{ciblue}{share\_busway}} & -- & -- \\
    Fähre & -- & \texttt{\textcolor{ciblue}{yes}} & -- & \texttt{route=\textcolor{ciblue}{ferry}} \\
    Fahrradstraße & \texttt{\textcolor{ciblue}{residential}} & \texttt{\textcolor{ciblue}{designated}} & -- & \texttt{bicycle\_road=\textcolor{ciblue}{yes}, maxspeed=\textcolor{ciblue}{30}, source:maxspeed=\textcolor{ciblue}{\allowbreak DE:bicycle\_road}, traffic\_sign=\textcolor{ciblue}{DE:244.1}} \\
    Fußgängerüberweg/-furt (Schiebestrecke) & \texttt{\textcolor{ciblue}{pedestrian}} & -- & -- & -- \\
    Fußgängerzone - immer befahrbar & \texttt{\textcolor{ciblue}{pedestrian}} & \texttt{\textcolor{ciblue}{yes}} & -- & -- \\
    Fußgängerzone (meist zeitlich begrenzt) & \texttt{\textcolor{ciblue}{pedestrian}} & -- & -- & -- \\
    Fußgängerzone - zeitlich begrenzt & \texttt{\textcolor{ciblue}{pedestrian}} & -- & -- & -- \\
    Gehweg (Fahrrad frei) & \texttt{\textcolor{ciblue}{footway}} & \texttt{\textcolor{ciblue}{yes}} & \texttt{\textcolor{ciblue}{designated}} & \texttt{traffic\_sign=\textcolor{ciblue}{DE:239,1022-10}} \\
    Gehweg (nur ZZ 1022-10) & \texttt{\textcolor{ciblue}{footway}} & \texttt{\textcolor{ciblue}{yes}} & \texttt{\textcolor{ciblue}{designated}} & \texttt{traffic\_sign=\textcolor{ciblue}{DE:239,1022-10}} \\
    Gehweg (Schiebestrecke) & \texttt{\textcolor{ciblue}{footway}} & -- & -- & -- \\
    Gemeinsamer Geh-/Radweg & \texttt{\textcolor{ciblue}{path}} & \texttt{\textcolor{ciblue}{designated}} & \texttt{\textcolor{ciblue}{designated}} & \texttt{segregated=\textcolor{ciblue}{no}} \\
    Getrennter Geh-/Radweg & \texttt{\textcolor{ciblue}{path}} & \texttt{\textcolor{ciblue}{designated}} & \texttt{\textcolor{ciblue}{designated}} & \texttt{segregated=\textcolor{ciblue}{yes}} \\
    Kommunaltrasse & \texttt{\textcolor{ciblue}{tertiary}} & \texttt{\textcolor{ciblue}{share\_busway}} & -- & \texttt{cycleway=\textcolor{ciblue}{share\_busway}} \\
    Kopenhagener Radweg & \texttt{\textcolor{ciblue}{cycleway}} & \texttt{\textcolor{ciblue}{designated}} & -- & -- \\
    Protected Bike Lane & \texttt{\textcolor{ciblue}{cycleway}} & \texttt{\textcolor{ciblue}{designated}} & -- & -- \\
    Radfahrstreifen & \texttt{\textcolor{ciblue}{tertiary}} & -- & -- & \texttt{cycleway:right=\textcolor{ciblue}{lane}, cycleway:right:bicycle=\textcolor{ciblue}{\allowbreak designated}} \\
    Radweg (mit Grünstreifen vom Gehweg getrennt) & \texttt{\textcolor{ciblue}{path}} & \texttt{\textcolor{ciblue}{designated}} & \texttt{\textcolor{ciblue}{designated}} & \texttt{segregated=\textcolor{ciblue}{yes}} \\
    Schutzstreifen & \texttt{\textcolor{ciblue}{tertiary}} & -- & -- & \texttt{cycleway:right=\textcolor{ciblue}{lane}, cycleway:lane=\textcolor{ciblue}{advisory}, cycleway:protection:\allowbreak right=\textcolor{ciblue}{dashed\_line}} \\
    Straße mit Mischverkehr ab 50 km/h & \texttt{\textcolor{ciblue}{tertiary}} & -- & -- & -- \\
    Straße mit Mischverkehr bis 30 km/h & \texttt{\textcolor{ciblue}{residential}} & -- & -- & -- \\
    Verkehrsberuhigter Bereich / Befahrbarer Wohnweg & \texttt{\textcolor{ciblue}{living\_street}} & -- & -- & -- \\
    Verkehrsberuhigter Geschäftsbereich & \texttt{\textcolor{ciblue}{living\_street}} & -- & -- & -- \\
    Wege in Grünflächen & \texttt{\textcolor{ciblue}{path}} & \texttt{\textcolor{ciblue}{designated}} & \texttt{\textcolor{ciblue}{designated}} & \texttt{segregated=\textcolor{ciblue}{no}} \\
    Wirtschaftsweg & \texttt{\textcolor{ciblue}{track}} & -- & -- & -- \\
    \hline
    \multicolumn{5}{p{23.5cm}}{\textbf{Additional Surface Mappings}: befestigt - nicht genauer erkennbar $\rightarrow$ \texttt{\textcolor{ciblue}{compacted}}, befestigt - zu detailieren $\rightarrow$ \texttt{\textcolor{ciblue}{compacted}}, Wassergebundene Decke $\rightarrow$ \texttt{\textcolor{ciblue}{compacted}}, unbefestigt $\rightarrow$ \texttt{\textcolor{ciblue}{unpaved}}, Betonplatten $\rightarrow$ \texttt{\textcolor{ciblue}{concrete:plates}}, Bituminöse Decke $\rightarrow$ \texttt{\textcolor{ciblue}{asphalt}}, Holz $\rightarrow$ \texttt{\textcolor{ciblue}{wood}}, Kunststein-Pflaster $\rightarrow$ \texttt{\textcolor{ciblue}{paving\_stones}}, Metall $\rightarrow$ \texttt{\textcolor{ciblue}{metal}}, Naturstein-Pflaster $\rightarrow$ \texttt{\textcolor{ciblue}{cobblestone}}}; \textbf{Feature Mappings}: Bahnübergang $\rightarrow$ \texttt{\textcolor{ciblue}{railway=level\_crossing}}, Treppe $\rightarrow$ \texttt{\textcolor{ciblue}{highway=steps}}, Fahrradroute $\rightarrow$ \texttt{\textcolor{ciblue}{type=route, route=bicycle, network=lcn}}, Brücke $\rightarrow$ \texttt{\textcolor{ciblue}{bridge=yes}}, Tunnel $\rightarrow$ \texttt{\textcolor{ciblue}{tunnel=yes}}}. \\
\end{tabular}
}
\end{table}
