...
- \Cref{tab:model-scores-drn} zeigt: Über den gesamten Datensatz evaluiert liegt der F1-Score bei 94.0\% und damit ca. 2\% höher als auf den OpenStreetMap Daten. Der Recall konnte auf 97\% verbessert werden, es sind also weniger falsch-positive festzustellen.
...
- Insgesamt manifestiert sich die messbare Verbesserung in der Genauigkeit des Fahrradroutings nicht nur in der stärkeren Striktheit des algorithmischen Modells, sondern auch generell in einer verbesserten Matching-Genauigkeit.
- Da das algorithmische Modell mehr Genauigkeit hinzugewonnen hat als das Machine Learning modell, könnte man mutmaßen, ob dies vielleicht mit einer generellen Vereinfachung des Matching-Problems zusammenhängt. 
...
- Trotz der sichtbaren Streuung des GNSS lässt sich erkennen, dass die aufgezeichneten Nutzertrajektorien deutlich besser mit dem DRN-Pfadnetzwerk übereinstimmen als mit OpenStreetMap
