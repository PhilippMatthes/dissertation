...
- Die Thematik Routing kann grundsätzlich in zwei Richtungen gedacht werden: 1. Das Erhalten von Kartenmaterialien, welche möglichst genau zur Infrastruktur passen und fehlerfrei sind, und 2. die Erstellung von Modellen (Routing-Profilen) welche die Routenwahl von Radfahrern genau nachvollziehen
