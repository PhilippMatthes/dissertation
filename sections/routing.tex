...
\caption{Measured deviations from actual bike infrastructure. Results for DRN and OpenStreetMap are based on \cite{lorenz_2022}.}%
...
\hline
\end{tabular}
\caption{Observed error cases among an arbitrary sample of 72 routes. Based on results from \cite{lorenz_2022}.}%
\label{tab:accuracy-comparison}%
\end{table}
