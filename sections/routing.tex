...
\caption{Comparison of paths in OpenStreetMap (a) and DRN (b). The DRN paths were mapped using \Cref{tab:tag-mapping} into the OpenStreetMap format. Unclassified paths are highlighted in red.}
...
\caption{Comparison of surface types in OpenStreetMap (a) and DRN (b). The DRN surface types were mapped using \Cref{tab:tag-mapping} into surface types available in the OpenStreetMap specification. Unclassified surfaces are highlighted in red.}
...
\caption{Measured deviations from actual bike infrastructure, given through our hand-drawn paths. DRN and OpenStreetMap results (Hausdorff distance and mean distance) were reproduced from \cite{lorenz_2022}.}%
