...
In the previous experiment, we have considered every GNSS sample equally. However, the distance estimation is likely harder when being far away from the traffic light, due to the chance of additional road bends until the traffic light is reached. A view of the over- and underestimation in relation to the actual traffic light distance, as depicted in \Cref{fig:routing-distance-scatter}, reveals that the 
