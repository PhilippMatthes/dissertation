...
Die erste Herausforderung besteht in der Prognose mehrerer tausend Ampeln im Stadtgebiet, sowie die Übermittlung der Prognose an das Smartphone. Die Inkompatibilität von an Kreuzungen ausgesendeten Kurzdistanz-Radionachrichten mit Smartphones verbietet es Radfahrern derzeit, auf die gleiche Vernetzungstechnologie wie Autos zurückzugreifen. In dieser Arbeit betrachten wir als Alternativkonzept die Erstellung einer zentralisierten über das mobile Internet erreichbaren Prognoseplattform. 

Datenausfälle, Skalierbarkeit
