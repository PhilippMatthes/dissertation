...
The first challenge investigated in this work is traffic light prediction. We obtain real-time states from thousands of traffic lights from a centralized data broker. Integrating this data broker requires 
