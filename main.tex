\documentclass[
  ...
  cdfont=false, % modify this to use the TUD font (Open Sans)
...
{\mdfsetup{%
frametitle={%
{\strut \color{cidarkblue}\textsf{#1}}}}%
}%
...
\hline
\rotatebox{90}{\footnotesize{\textbf{High cycle-independent instability}}} & & \includegraphics[width=0.42\linewidth]{images/predictability-cycles-2.pdf} \\
\hline
